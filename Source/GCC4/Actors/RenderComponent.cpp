...
shared_ptr<SceneNode> SphereRenderComponent::VCreateSceneNode(void)
{
	...
	else if (GameCodeApp::GetRendererImpl()==GameCodeApp::Renderer_D3D11)
	{
		...
		//shared_ptr<SceneNode> sphere(GCC_NEW D3DShaderAssimpMeshNode11(m_pOwner->GetId(), wbrcp, "art\\sphere.sdkmesh", RenderPass_Actor, &pTransformComponent->GetTransform()));
